...
from haberler.api.serializers import MakaleSerializer, YazarSerializer
...
class YazarListCreateAPIView(APIView):
    
    def get(self, request):
        yazarlar = Yazar.objects.all()
        serializer = YazarSerializer(yazarlar, many=True, context={"request": request})
        return Response(serializer.data)

    
    def post(self, request):
        serializer = YazarSerializer(data=request.data)
...
#                "errors": {
#                    "code": 404,
#                    "message": f"({pk}) id numaralı makale bulunamadı!"
#                }
#            }, 
